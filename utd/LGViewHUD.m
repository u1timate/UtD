...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
		...
		bottomLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, frame.size.height-2*offset/1.5, frame.size.width, 50)];
        ...
        bottomLabel.adjustsLetterSpacingToFitWidth = YES;
		...
		imageView = [[UIImageView alloc] initWithFrame:CGRectMake(frame.size.width/4.0, frame.size.height/6.0,
