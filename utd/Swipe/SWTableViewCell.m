...
- (void)layoutSubviews
{
    ...
    self.imageView.frame = CGRectMake(iframe.origin.x + 5, iframe.origin.y + 5, 45, 45);
    
    iframe = self.textLabel.frame;
    
    self.textLabel.frame = CGRectMake(self.imageView.frame.origin.x + self.imageView.frame.size.width + 15, iframe.origin.y, iframe.size.width, iframe.size.height);
    
    iframe = self.detailTextLabel.frame;
    
    self.detailTextLabel.frame = CGRectMake(self.imageView.frame.origin.x + self.imageView.frame.size.width + 15, iframe.origin.y, iframe.size.width, iframe.size.height);
